					...
					<div class="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-1 relative">
						...
						<div class="flex flex-row justify-around items-center gap-6">
							<div class="flex-1 text-center">
								<div class="text-md md:text-lg font-semibold text-gray-700 mb-2 h-20 flex items-center justify-center">${match.teams[0]}</div>
							...
							<div class="flex-1 text-center">
								<div class="text-md md:text-lg font-semibold text-gray-700 mb-2 h-20 flex items-center justify-center">${match.teams[1]}</div>
